...
//Local Search and VND - em fun��o de neighborhood_size
	...
	public Solution runMethod(Problem p, Solution so, int id_agent) {
		...
		while (improved) {
			...
			if(criteria.acceptationCriteria(this.s_line, this.best_solution,element, p)) {
				...
				//System.out.println("Melhorou a solu��o!");
				//this.s_line.showOFAndFitness(p);
				
				//Reinforcement Learning
				if(p.getProblemType(0).equals("min")) { //testando para 1 dimens�o
				...
				states_count++;
				states[next_state] = -1;
				//System.out.println("N�o melhorou a solu��o!");
