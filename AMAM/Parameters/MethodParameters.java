...
public class MethodParameters {
	...
	private Element element;      		//elementos espec�ficos do problema

	//Metaheuristics
	private String mth_type;      		//m�todo implementada
	private String stop_cond_type;     	//tipo de condi��o de parada do m�todo
	private String accept_crit_type;	//tipo de crit�rio de aceita��o do m�todo
	private int max_iterations; 
	private int max_levels_perturbation;
	
	//Construction
	private String constr_type;   		//contru��o utilizada pelo m�todo
	private int rcl_size;				//tamanho da lista restrita de candidatos
	private int portion_size;
	
	//LocalSearch
	private String ls_type;       		//busca local utilizada pelo met�do
	private int neighborhood_size; 		//n�mero de 
