...
public class VRPSolution extends Solution{
	...
	public VRPSolution(int receiver_size, Problem p) {
		...
		//nenhuma rota � inicializada aqui, s� ser�o inicializadas quando necess�rio	
	}
	...
	//Insere o cliente na posi��o pos e atualiza os valores necess�rios
	...
	//verfica se uma rota tem ou n�o viola��o de janela de tempo
	...
	//encontra posi��o para o cliente "cand", sem considerar a rota atual dele
	public void testBetterPositionInOtherRoute(int cand, int current_route, VRPConstructElement e, VRPProblem p, int receiver_size) {
		...
		for(int i = 0; i < this.getNumberRoutes(); i++) {
			...
			if(i != current_route) { //n�o considerar a rota atual do candidato
	...
	//A single shift - (Realoca��o - Inter-rota)
