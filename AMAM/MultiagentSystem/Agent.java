...
public class Agent extends ThreadBase{
	...
	public synchronized void run() {
		...
		this.handler.notifyFinishThread();//notifica que o agente terminou a execu��o do seu m�todo
		
	}
	
	//DEFINITION OF OBSERVER ------ ALL AGENTS ARE OBSERVERS ------
	public void update() {
		//System.out.println("\nNOVO ELEMENTO INSERIDO NO POOL: Ver chamada de comandos para atualizar quando receber uma notifica��o do Pool");
	}
